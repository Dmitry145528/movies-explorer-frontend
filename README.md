...
### Важно: Пожалуйста, не используйте команду serve -s build для запуска в режиме разработки, так как она может вызвать ошибки. Вместо этого, используйте команду npm run dev.