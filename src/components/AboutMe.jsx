    ...
    <section className="about-me">
      ...
      <div className="about-me__content">
        <article className="about-me__description">
          ...
          <p className="about-me__description_text">Я родился в Москве и сейчас учусь на курсе веб-разработчика от Яндекс Практикума. Каждый день для меня – это новые строчки кода и открытия в мире программирования. Кроме того, я также работаю в компании MuzMsk и являюсь одним из основателей MUZKABEL</p>
